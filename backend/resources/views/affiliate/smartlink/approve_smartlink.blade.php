                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mt-3  table-responsive">
                                    ...
                                    <table id="rejected_smartlink_table"
...
@section('js')
    ...
    <script type="text/javascript">
        $(function() {
            var rejected_smartlink_table = $('#rejected_smartlink_table').DataTable({
            ...
            $('#rejected_smartlink_table').on('click', '.rejectData', function() {
