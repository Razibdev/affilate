...
@if (!empty(Auth::guard('affliate')->user()->name))
@php $data=UserSystemInfoHelper::site_settings();@endphp
    ...
    <head>
        ...
        <title>{{  $data->site_name }} Manager Panel</title>
        <link rel="apple-touch-icon" sizes="180x180"
            href="{{ asset('site_images') }}/{{ $data->icon }}">
        ...
        <meta name="msapplication-TileImage"
            content="{{ asset('site_images') }}/{{ $data->icon }}">
    ...
    <body>
        ...
        <!-- ===============================================-->
        @php
            $user = UserSystemInfoHelper::get_first_publisher(Auth::guard('affliate')->user()->id);
            ...
            <div class="container" data-layout="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
                        <div class="navbar-vertical-content scrollbar">
                            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ url('manager') }}" role="button"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('manager.view-offer-detail') }}"
                                        role="button" aria-controls="dashboard">
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas fa-book"></span></span><span
                                                class="nav-link-text ps-1">View Offer Details</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link dropdown-indicator" href="#manage-publisher" role="button"
                                        data-bs-toggle="collapse" aria-expanded="true" aria-controls="manage-publisher">
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas fa-user-graduate"></span></span><span
                                                class="nav-link-text ps-1">Publishers</span>
                                        </div>
                                    </a>
                                    <ul class="nav collapse" id="manage-publisher">
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ url('manager/manage-publisher') }}" aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">My Publisher</span>
                                                </div>
                                            </a>

                                        </li>
                                        <li class="nav-item"><a class="nav-link"
                                                href="{{ url('manager/pending-publisher') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Pending Publisher</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                        <li class="nav-item"><a class="nav-link"
                                                href="{{ url('manager/rejected-publisher') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Rejected Publisher</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link dropdown-indicator" href="#offers" role="button"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="far fa-compass"></span></span><span
                                                class="nav-link-text ps-1">Approval request</span>
                                        </div>
                                    </a>
                                    <ul class="nav collapse" id="offers">
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ route('manager.approval-request') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Pending Offer Approval
                                                        Request</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ route('manager.approve-approval-request') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Approved Offer Request</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ route('manager.reject-approval-request') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Rejected Offer Request</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link dropdown-indicator" href="#Leads_process" role="button"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                ...
                                                class="nav-link-text ps-1">Smartlinks</span>
                                        </div>
                                    </a>
                                    <ul class="nav collapse" id="Leads_process">
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ route('manager.pending-smartlinks') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Pending Smartlinks</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ route('manager.approve-smartlinks') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Approved Smartlink</span>
                                                </div>
                                            </a>
                                        </li>
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ route('manager.rejected-smartlinks') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">rejected-smartlinks</span>
                                                </div>
                                            </a>
                                        </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('manager.generate-link') }}"
                                        role="button" aria-controls="Generate_Link">
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="far fa-sticky-note"></span></span><span
                                                class="nav-link-text ps-1">Generate Link</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('manager.payment') }}" role="button"
                                        aria-controls="Salary_History">
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="far fa-money-bill-alt"></span></span><span
                                                class="nav-link-text ps-1">Salary History</span>
                                        </div>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('manager.chat', (isset($user->id))?$user->id:'0') }}"
                                        role="button" aria-controls="Salary_History">
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                ...
                                <li class="nav-item">
                                    <a class="nav-link dropdown-indicator" href="#Messages" role="button"
                                        data-bs-toggle="collapse" aria-expanded="true" aria-controls="Messages">
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                    class="fas fa-sms"></span></span><span
                                                class="nav-link-text ps-1">Messages</span>
                                        </div>
                                    </a>
                                    <ul class="nav collapse" id="Messages">
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ route('manager.support') }}" aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Send Message</span>
                                                </div>
                                            </a>

                                        </li>
                                        <li class="nav-item"><a class="nav-link"
                                                href="{{ route('manager.view-publisher-messages') }}"
                                                aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">View Publisher Messages</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link dropdown-indicator" href="#Domain" role="button"
                                        ...
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                                                ...
                                                class="nav-link-text ps-1">Mail Room</span>
                                        </div>
                                    </a>
                                    <ul class="nav collapse" id="Domain">
                                        <li class="nav-item"><a class="nav-link "
                                                href="{{ route('manager.mail-room') }}" aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">Send Message</span>
                                                </div>
                                            </a>
                                        ...
                                        <li class="nav-item"><a class="nav-link"
                                                href="{{ route('manager.view-mail') }}" aria-expanded="false">
                                                <div class="d-flex align-items-center"><span
                                                        class="nav-link-text ps-1">View Send Mail</span>
                                                </div>
                                            </a>
                                            <!-- more inner pages-->
                                        </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('manager.settings') }}" role="button"
                                        aria-controls="dashboard">
                                        <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                ...
                <div class="content">
                    <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
                        ...
                        <a class="navbar-brand me-1 me-sm-3" href="{{route('manager.dashboard')}}">
                        ...
                        <ul class="navbar-nav align-items-center d-none d-lg-block">
                            <li class="nav-item">
                                <div class="search-box" data-list='{"valueNames":["title"]}'>
                                    ...
                                    <div
                                        class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100" id="all_offers_results">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-card dropdown-menu-notification"
                                    ...
                                    <div class="card card-notification shadow-none">
                                        ...
                                        <div class="card-footer text-center border-top"><a class="card-link d-block"
                                                href="{{ route('manager.view-publisher-messages') }}">View all</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser"
                                    ...
                                    <div class="avatar avatar-xl">
                                        <img class="rounded-circle"
                                            src="{{ UserSystemInfoHelper::publishar_image(Auth::guard('affliate')->user()->photo) }}"
                                            alt="" />
                                ...
                                <div class="dropdown-menu dropdown-menu-end py-0"
                                    ...
                                    <div class="bg-white dark__bg-1000 rounded-2 py-2">
                                        <a class="dropdown-item fw-bold text-warning" href="#!"><span
                                                class="fas fa-crown me-1"></span><span>{{ Auth::guard('affliate')->user()->name }}</span></a>

                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                            href="{{ route('manager.chat', (isset($user->id))?$user->id:'0') }}">Chats</a>
                                        <a class="dropdown-item" href="{{ route('manager.settings') }}">Profile
                                            &amp; Account</a>
                                        <a class="dropdown-item"
                                            href="{{ route('manager.generate-link') }}">Affliate Link</a>

                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                            href="{{ route('manager.settings') }}">Settings</a>

                                        <a class="dropdown-item" href="{{ route('manager.logout') }}"
                                            onclick="event.preventDefault();
                                                         document.getElementById('affliate-logout-form').submit();">
                                            {{ __('Logout') }}
                                        </a>

                                        <form id="affliate-logout-form" action="{{ route('manager.logout') }}"
                    ...
                    <footer class="footer">
                        <div class="row g-0 justify-content-between fs--1 mt-4 mb-3">
                            <div class="col-12 col-sm-auto text-center">
                                <p class="mb-0 text-600">Copyright @ <a href="https://kingsofaffiliate.com">KingsOfAffiliate Team</a><span class="d-none d-sm-inline-block">| </span><br class="d-sm-none"> All Right Reserved.
                                </p>
                            </div>
                            <div class="col-12 col-sm-auto text-center">
        ...
        <script>
            $(function() {
                $('#offer_search_box').keyup(function() {
                    ...
                    $.ajax({
                        url: "{{ route('manager.search_offer_dashboard') }}",
                        type: 'post',
                        dataType: 'JSON',
                        headers: {
                            "X-CSRFToken": csrf
