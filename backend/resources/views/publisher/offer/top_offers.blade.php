                      ...
                      children[13].childNodes[1].innerHTML=this.value;" />
                                     ...
                                     <div class="col-lg-3">
                                         ...
                                         <input type="hidden" name="page_type" class="form-control"
                                             placeholder="Enter Name Keyword" value="top_offers">
                                     </div>
                                     <div class="col-lg-2">
                                     ...
                                     <div class="col-lg-3">
                                         ...
                                         <select class="js-example-basic-multiple" name="ua_target[]" id="ua_target"
                                             multiple data-actions-box="true" style="width: 100%">
                                     ...
                                     <div class="col-lg-4">
                                         ...
                                         <select name="category[]" class="js-example-basic-multiple" multiple
                                 ...
                                 <input type="hidden" id="offer_page_name" name="offer_page_name" value="top">
                             </form>
                         </div>
