         ...
         <div class="page-content">
                 ...
                 <div class="col-lg-12 ">
                     <div class="card radius-10">
                         <div class="card-header">
                             <h5 class="mb-0">Filter My Offers</h5>
                         </div>
                         <div class="card-body">
                      ...
                      children[13].childNodes[1].innerHTML=this.value;" />
                                     ...
                                     <div class="col-lg-3">
                                         ...
                                         <input type="hidden" name="page_type" class="form-control"
                                             placeholder="Enter Name Keyword" value="all_offer">
                                     </div>
                                     <div class="col-lg-2">
                                         <label class="form-label">Offer ID</label>
                                         <input type="" name="id" class="form-control"
                                             placeholder="Enter Offer ID" id="id">
                                     </div>
                                 ...
                                 <input type="hidden" id="offer_page_name" name="offer_page_name" value="my">
                             </form>
                         </div>
             ...
             <div class="row">
                 <div class="col-lg-12 mt-3  table-responsive">
                     <div class="card ">
                         <div class="card-header">
                             <h5 class="mb-0">View My Offers</h5>
                         </div>
                         <div class="card-body">
