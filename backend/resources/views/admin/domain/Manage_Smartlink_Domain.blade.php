    ...
    <div class="page-content-wrapper">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12 text-right mb-4 mt-2">
                                <button class="btn btn-primary  add_model" type="button" data-bs-toggle="modal"
                                    data-bs-target="#addModal">Add Traking Domain</button>
                            </div>

                            <div class="col-lg-12 table-responsive">
                                <table id="smart_link_datatable"
        ...
        @section('js')
            ...
            <script type="text/javascript">
                $(function() {
                    var smart_link_datatable = $('#smart_link_datatable').DataTable({
                        processing: true,
                        serverSide: true,
                        responsive: false,
                        scrollX: true,
                        ajax: "{{ route('admin.show-smartlink-domain') }}",
                        columns: [{
                                "data": "id"
                            },
                            {
                    ...
                    $('#smart_link_datatable').on('click', '.editData', function(e) {
                        e.preventDefault()
                    ...
                    $('#smart_link_datatable').on('click', '.deleteData', function() {
                        let id = $(this).attr('data-id');
                        Swal.fire({
                            title: 'Are you sure?',
                            text: "You want to remove this Traking Domain ",
                            type: 'warning',
                            ...
                            if (result.value) {
                                $.ajax({
                                    url: "{{ route('admin.delete-smartlink-domain') }}",
                                    type: 'GET',
                                    dataType: 'JSON',
                                    data: {
                                        id: id
                    ...
                    $('#btnUpdate').unbind().click(function() {
                        ...
                        $.ajax({
                            url: "{{ route('admin.update-smartlink-domain') }}",
                            type: 'POST',
                            dataType: 'JSON',
                            data: data,
                            success: function(result) {
                    ...
                    $('#btnSave').unbind().click(function() {
                        ...
                        $.ajax({
                            url: "{{ route('admin.insert-smartlink-domain') }}",
                            type: 'POST',
                            dataType: 'JSON',
                            data: data,
                            success: function(result) {
