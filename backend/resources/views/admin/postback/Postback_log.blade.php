...
@section('content')
 ...
 <div class="row">
    			<div class="col-lg-12 mt-3  table-responsive">
    				...
    				<table id="post_back_log" class="table table-bordered table-striped dt-responsive nowrap"
...
@section('js')
    ...
    <script type="text/javascript">
        $(function() {
            var post_back_log = $('#post_back_log').DataTable({
                processing: true,
                serverSide: true,
                responsive: true,
                ajax: "{{ route('admin.show-postback-log') }}",
                columns: [{
                        "data": "id"
                    },
                    {
            ...
            $('#post_back_log').on('click', '.approveData', function() {
            ...
            $('#post_back_log').on('click', '.rejectData', function() {
                let id = $(this).attr('data');
                Swal.fire({
                    title: 'Are you sure?',
