                    ...
                    <div class="card radius-10">
                        ...
                        <div class="card-body">
                                            ...
                                            <span id="offer_name1">
                                                ...
                                                @foreach ($device as $d)
                                                    ...
                                                    @elseif($d == 'Internet Explorer')
                                                        <i class="fadeIn animated fab fa-internet-explorer" title="Internet Explorer"></i>
                                                    @elseif($d == 'OPERA MINI')
                            ...
                            @if ($qry->offer_type == 'private')
                                        ...
                                        @php $q=DB::table('approval_request')->where('offer_id',$qry->oid)->where('publisher_id',Auth::guard('publisher')->id())->first();
                                         @endphp
                             ...
                             @else(@$q->approval_status=='Rejected')
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="alert alert-success" role="alert" style="height: auto;width:100%;">
                                        <span id="offer_name1">
                                            <@php  $device=explode('|',$qry->ua_target); @endphp @foreach ($device as $d)
                                                @if ($d == 'Windows')
