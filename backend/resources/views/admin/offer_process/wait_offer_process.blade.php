                            ...
                            <form action="{{ url('admin/lead/search') }}" method="get">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a class="btn m-2 btn-sm btn-danger rejectSelected" id="rejectSelected"
                                            type="button">Reject
                                            Selected</a>
                                        <a class="btn m-2 btn-sm btn-danger rejectAll" id="rejectAll" type="button">Reject
                                            All</a>
                                        <a class="btn m-2 btn-sm btn-success approveSelected" id="approveSelected"
                                            type="button">Approve
                                            Selected</a>
                                        <a class="btn m-2 btn-sm btn-success approveAll" id="approveAll"
        ...
        $(function() {
            ...
            var offer_process_table = $('#offer_process_table').DataTable({
                ...
                $('#approveSelected').click(function() {
                    ...
                    console.log(data);
                    var searchIDs = $('.process_offer_table input:checked').map(function() {
