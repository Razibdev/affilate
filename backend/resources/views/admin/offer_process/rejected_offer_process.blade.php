                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <!-- <a class="btn btn-sm m-2 btn-success approveSelected" id="approveSelected"
                                        type="button">Approve Selected</a>
                                    <a class="btn btn-sm m-2 btn-success approveAll" id="approveAll"
                                        type="button">Approve All</a> -->

                                    <a class="btn btn-sm m-2 btn-danger  deleteSelected" id="deleteSelected" type="button">Delete Selected</a>
                                    <a class="btn btn-sm m-2 btn-danger  deleteAll" id="deleteAll" type="button">Delete All</a>
