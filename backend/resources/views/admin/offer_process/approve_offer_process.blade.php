                ...
                <div class="col-lg-12 ">
                    <div class="card radius-10">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                <a class="btn btn-sm m-2  btn-warning rejectSelected" id="rejectSelected" type="button">Reject Selected</a>
                                <a class="btn btn-sm m-2 btn-warning  rejectAll" id="rejectAll" type="button">Reject All</a>
                                </div>
                            </div>
