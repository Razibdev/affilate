...
<meta http-equiv="Refresh" content="3;url={{ config('app.url')}}/manager/">
<style>
*{
margin:0;
padding:0;
...
<p>
<img style="height:80%;width:100%;" src="{{ UserSystemInfoHelper::publishar_image(Auth::guard('affliate')->user()->photo) }}"/>
</p>
</div>
