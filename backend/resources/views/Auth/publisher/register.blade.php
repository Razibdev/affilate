...
@section('content')
 ...
 <input type="hidden" name="affliate" value="{{ app('request')->input('id') }}">
                                ...
                                <fieldset>
                                    ...
                                    <input type="button" name="next" class="next mb-4 action-button"
                                        data-field="account_information" value="Next Step" />
                                </fieldset>
                                <fieldset>
                                    <div class="form-card">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="country">
                                                    ...
                                                    @foreach ($country_list as $q)
                                                        <option value="{{ $q->country_name }}" {{ ($q->country_name=='UNITED STATES')?'selected':''}}>{{ $q->country_name }}
                                                        </option>
                                                    @endforeach
                                        ...
                                        <div class="col-lg-12 m-auto  pb-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="phone_code"
                                                    ...
                                                    @foreach ($country_list as $q)
                                                        <option value="{{ $q->phonecode }}" {{ ($q->country_name=='UNITED STATES')?'selected':''}}>+{{ $q->phonecode }}
                                                            ({{ $q->country_name }})
                                                        </option>
                                                    @endforeach
                                    ...
                                    <input type="button" name="previous" class=" mb-4 previous action-button-previous"
                                        value="Previous" />
                                    <input type="button" name="next" class="mb-4 next action-button"
                                        data-field="addistional_information" value="Next Step" />
                                </fieldset>
                                <fieldset>
                                    <div class="form-card">
                                    ...
                                    <input type="button" name="previous" class="mb-4 previous action-button-previous"
                                        value="Previous" />
                                    <input type="button" name="make_payment" class="mb-4 next action-button"
                                        data-field="website_information" value="Confirm" />
                                </fieldset>
                                <fieldset>
                                    <div class="form-card">
                                    ...
                                    <input type="button" name="previous" class="mb-4 previous action-button-previous"
                                        value="Previous" />
                                    <button type="submit" class="mb-4 btn btn-primary" id="submit">Submit</button>
                                </fieldset>
                            </form>
                        </div>
                    </div>
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if (!result.status) {
                            ...
                            location.replace('{{ route('publisher.login') }}');
                            form[0].reset();
